...
CREATE TABLE `produto_pedido` (
  ...
  CONSTRAINT `produto_pedido_ibfk_1` FOREIGN KEY (`pedido_id`) REFERENCES `pedido` (`id`),
  CONSTRAINT `produto_pedido_ibfk_2` FOREIGN KEY (`produto_id`) REFERENCES `produto` (`id`)
